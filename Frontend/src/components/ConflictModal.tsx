      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-4xl mx-4 max-h-[80vh] overflow-hidden">
        ...
        <div className="mb-6">
          <p className="text-gray-700">
            Two users have edited the same task simultaneously. Please choose
          ...
          <div className="border border-blue-200 rounded-lg p-4 bg-blue-50">
            ...
            <div className="space-y-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-900">
                  {conflict.currentVersion.description}
                </p>
              </div>
              <div>
                <span className="text-sm font-medium text-gray-700">
              ...
              <div className="flex items-center space-x-1 text-gray-500">
                ...
                <span className="text-xs">
                  Modified:{" "}
                  {new Date(conflict.currentVersion.updatedAt).toLocaleString()}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="border border-red-200 rounded-lg p-4 bg-red-50">
            ...
            <div className="space-y-2">
              <div>
                ...
                <p className="text-sm text-gray-900">
                  {conflict.incomingVersion.title}
                </p>
              </div>
              <div>
                <span className="text-sm font-medium text-gray-700">
              ...
              <div className="flex items-center space-x-1 text-gray-500">
                ...
                <span className="text-xs">
                  Modified:{" "}
                  {new Date(
                    conflict.incomingVersion.updatedAt
                  ).toLocaleString()}
                </span>
              </div>
            </div>
        ...
        <div className="flex justify-end space-x-3">
          <button
            onClick={() =>
              onResolve(conflict.taskId, "overwrite", conflict.currentVersion)
            }
          ...
          <button
            onClick={() =>
              onResolve(conflict.taskId, "overwrite", conflict.incomingVersion)
            }
